...
export const translations = {
  en: {
    ...
    // Work Types
    workTypeRegular: 'Regular',
    workTypeOvertime: 'Overtime',
    workTypeHoliday: 'Holiday',
    workTypeSickLeave: 'Sick Leave',
    workTypeAbsent: 'Absent',
    workTypeLeave: 'Leave',
    workTypeWeekend: 'Weekend',
    workTypePublicHoliday: 'Public Holiday',
    ...
    selectEmployeeToSubmit: 'Select an employee to submit timesheet',
    noEmployeesInTeam: 'No employees assigned to your team',
    timesheetEntries: 'Timesheet Entries',
    addTimesheetEntry: 'Add Timesheet Entry',
    ...
    emptyHistory: 'No timesheet history available',
  ...
  ar: {
    ...
    // Work Types
    workTypeRegular: 'عادي',
    workTypeOvertime: 'عمل إضافي',
    workTypeHoliday: 'عطلة',
    workTypeSickLeave: 'إجازة مرضية',
    workTypeAbsent: 'غائب',
    workTypeLeave: 'إجازة',
    workTypeWeekend: 'نهاية الأسبوع',
    workTypePublicHoliday: 'عطلة عامة',

    // Manager Portal Data
    myTeamDashboard: 'لوحة معلومات فريقي',
    totalTeamMembers: 'إجمالي أعضاء الفريق',
    pendingSubmissions: 'الإرسالات المعلقة',
    submittedThisWeek: 'المرسلة هذا الأسبوع',
    averageHoursPerDay: 'متوسط الساعات في اليوم',
    selectEmployeeToSubmit: 'حدد موظفاً لإرسال الجدول الزمني',
    noEmployeesInTeam: 'لا توجد موظفون مخصصون لفريقك',
    timesheetEntries: 'إدخالات الجدول الزمني',
    addTimesheetEntry: 'إضافة إدخال جدول زمني',
    employeeTimesheet: 'جدول زمني للموظف',
    submissionDate: 'تاريخ الإرسال',
    submittedBy: 'مرسل من قبل',
    reviewedBy: 'تمت مراجعته من قبل',
    reviewDate: 'تاريخ المراجعة',
    correctionNotes: 'ملاحظات التصحيح',
    noCorrectionsNeeded: 'لا توجد تصحيحات مطلوبة',
    recentSubmissions: 'الإرسالات الأخيرة',
    viewFullHistory: 'عرض السجل الكامل',
    timesheetDetails: 'تفاصيل الجدول الزمني',
    employeeDetails: 'تفاصيل الموظف',
    employeeCode: 'رمز الموظف',
    jobTitle: 'المسمى الوظيفي',
    submissionStatus: 'حالة الإرسال',
    reviewStatus: 'حالة المراجعة',
    totalHoursWorked: 'إجمالي الساعات المعملة',
    totalOvertimeHours: 'إجمالي ساعات العمل الإضافي',
    filterByStatus: 'تصفية حسب الحالة',
    filterByDate: 'تصفية حسب التاريخ',
    allStatuses: 'جميع الحالات',
    noSubmissions: 'لم يتم العثور على إرسالات',
    emptyHistory: 'لا يوجد سجل جدول زمني متاح',
    syncStatus: 'حالة المزامنة',
    lastSyncedAt: 'آخر مزامنة في',
    offlineDraft: 'مسودة دون الاتصال',
